...
with open('Surname_Name_Patronymic', 'a') as data:
    data.write('Ivanov Ivan Ivanovich Иванович\n')
    data.write('Петров Петр Петрович\n')
    data.write('Любимый Любимчик Петрович\n')
    data.write('Самый Лучший Сотрудник\n')
    data.write('Козлов Инокентий Дмитриевич\n')
