...
print(get_list_data('C:/Users/annam/Desktop/python_homework/seminar4_01.12/Students_and_marks.txt')) #здесь указала путь к файлу, так как при вводе имени файла выходит ошибка "FileNotFoundError: [Errno 2] No such file or directory: 'Students_and_marks.txt'"