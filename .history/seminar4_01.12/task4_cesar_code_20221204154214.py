...
#     with open('cesar_encrypted.txt','a', encoding='utf-8') as data:
...
# key = give_int('Введите ключ (положительное число для сдвига вправо, отлицательное - для сдвига влево:\n')
