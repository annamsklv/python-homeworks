...
languages_lst_cap = [languages_lst[i].upper for i in len(languages_lst)]
# def elenents_to_upper(lst:list) -> list:
#         for i in range(len(lst)):
#                 lst[i]

list_of_tuples = lambda x,y: list(zip(x,y))

num_lang_lst = list_of_tuples(numbers_lst, languages_lst)
