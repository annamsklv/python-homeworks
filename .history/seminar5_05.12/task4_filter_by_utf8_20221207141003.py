...
def list_of_tuples_cap(lst1: list, lst2: list):
        lst_cap = [i.upper() for i in lst2]
        lst_of_tuples = lambda lst1,lst2: list(zip(lst1,lst_cap))
...
num_lang_lst = list_of_tuples_cap(numbers_lst, languages_lst_cap)
